...
// INFO: Define the constant buffer structure that stores position
struct CBUFFER0
{
	XMFLOAT3 position;
	float padding;
...
void Renderer::InitGraphics()
{
	...
	Vertex vertices[] =
	{
		...
		{ XMFLOAT3{0.5f, 0.5f, -0.5f},		XMFLOAT4{Colors::Red} }, // FRONT TR
		{ XMFLOAT3{0.5f, -0.5f, -0.5f},		XMFLOAT4{Colors::Green} }, // FRONT BR
		
		{ XMFLOAT3{-0.5f, -0.5f, 0.5f},		XMFLOAT4{Colors::Red} }, // BACK BL
		{ XMFLOAT3{-0.5f, 0.5f, 0.5f},		XMFLOAT4{Colors::Green} }, // BACK TL
		{ XMFLOAT3{0.5f, 0.5f, 0.5f},		XMFLOAT4{Colors::Red} }, // BACK TR
		{ XMFLOAT3{0.5f, -0.5f, 0.5f},		XMFLOAT4{Colors::Green} } // BACK BR
	};
...
void Renderer::RenderFrame()
{
	...
	CBUFFER0 cBuffer0 = {};
	cBuffer0.position = XMFLOAT3(xPosition, yPosition, 1.0f);
