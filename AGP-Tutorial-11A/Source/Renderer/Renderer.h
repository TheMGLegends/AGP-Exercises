...
private:
	...
	ID3D11InputLayout* pInputLayoutParticle;
	ID3D11VertexShader* pVSParticle;
	ID3D11PixelShader* pPSParticle;
	ID3D11RasterizerState* pRasterParticleSolid;
	ID3D11RasterizerState* pRasterParticle;
	ID3D11Buffer* pParticleVertexBuffer;
