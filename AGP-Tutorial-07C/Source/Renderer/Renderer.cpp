...
Renderer::Renderer() : pDevice(nullptr), pDeviceContext(nullptr), pSwapChain(nullptr), pRenderTargetView(nullptr), pZBuffer(nullptr),
					   ...
					   pPixelShader(nullptr), pTexture(nullptr), pSamplerState(nullptr), pAlphaBlendStateEnable(nullptr), 
					   pAlphaBlendStateDisable(nullptr), width(0), height(0), camera(), cube1(), cube2(), viewport(), spriteFont(nullptr), 
					   spriteBatch(nullptr), hWndCache(nullptr), rc(), pDepthStencilState(nullptr) 
